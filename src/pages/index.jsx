...
import { Layout, Wrapper, SocialLink } from '../components'
            ...
            <Social>
              {social.edges.map((s, index) => (
                <SocialLink
                  ...
                  index={index}
                  label={s.node.primary.label.text}
                  url={s.node.primary.link.url}
                  fontAwesomeIcon={s.node.primary.font_awesome_icon.text}
                />
              ))}
            </Social>
          </HeroInner>
